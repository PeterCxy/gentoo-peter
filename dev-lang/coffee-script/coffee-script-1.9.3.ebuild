...
# instead.
SRC_URI="https://github.com/jashkenas/${MY_PN}/archive/${PV}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/${MY_PN}-${PV}"
...
RDEPEND="virtual/node"

DEPEND="${RDEPEND}
	vim-syntax? ( app-vim/coffee-script-syntax )"
...
src_install(){
	...
	doexe bin/coffee
	doexe bin/cake # Do not forget to have a cake
